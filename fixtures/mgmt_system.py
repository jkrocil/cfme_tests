...
def has_no_cloud_providers():
    ...
    the current appliance.
    """
    BaseProvider.clear_provider_by_type(BaseProvider.base_types['cloud'], validate=True)
...
def has_no_infra_providers():
    ...
    the current appliance.
    """
    BaseProvider.clear_provider_by_type(BaseProvider.base_types['infra'], validate=True)
...
def has_no_container_providers():
    ...
    the current appliance.
    """
    BaseProvider.clear_provider_by_type(BaseProvider.base_types['container'], validate=True)


@pytest.fixture
def has_no_middleware_providers():
    """Clear all middleware providers."""
    BaseProvider.clear_provider_by_type(BaseProvider.base_types['middleware'], validate=True)
